...
const DEFAULT_CANDIDATE_V3_MAX_PER_CYCLE = 1;
...
module.exports = {
  ...
  CANDIDATE_V1_ALERTS_ENABLED: parseBoolean(process.env.CANDIDATE_V1_ALERTS_ENABLED, false),
  ...
  CANDIDATE_V3_ENABLED: parseBoolean(process.env.CANDIDATE_V3_ENABLED, true),
  CANDIDATE_V3_MAX_PER_CYCLE: parsePositiveInt(
    process.env.CANDIDATE_V3_MAX_PER_CYCLE,
    DEFAULT_CANDIDATE_V3_MAX_PER_CYCLE
  ),
};
