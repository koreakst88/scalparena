...
const DEFAULT_CANDIDATE_V2_SHADOW_MAX_PER_CYCLE = 3;
...
module.exports = {
  ...
  CANDIDATE_V2_SHADOW_ENABLED: parseBoolean(process.env.CANDIDATE_V2_SHADOW_ENABLED, true),
  CANDIDATE_V2_SHADOW_MAX_PER_CYCLE: parsePositiveInt(
    process.env.CANDIDATE_V2_SHADOW_MAX_PER_CYCLE,
    DEFAULT_CANDIDATE_V2_SHADOW_MAX_PER_CYCLE
  ),
};
